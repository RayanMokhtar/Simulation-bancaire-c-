...
/**
 * This class regroup statistic information. It calculates the simulation result.
 */
public class StatisticManager {
	...
	/**
	 * Time unit count of occupied cashier. For each unit time, if we have an occupied cashier, we get this count + 1.
	 */
	...
	/**
	 * Calculates the rate of served client among all clients.
	 * This indicates the client satisfaction.  
	 * 
